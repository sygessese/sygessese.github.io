      ...
      <CvContainer>
        ...
        <CvSection
          ...
          contents={[
            {
              details:
                "React, Bootstrap, jQuery, Styled Components, GatsbyJS, Webpack, Babel, Flux <br> Node.js, Express, MySQL, PostgreSQL, Cassandra, MongoDB",
            },
          ]}
        />
        <CvSection
          section="tools"
          contents={[
            { details: "Git, AWS, Docker, Jest, Postman, Loader.io, Heroku" },
          ]}
        />
        <CvSection
          section="education"
          ...
          contents={[
            {
              ...
              details: `Constructed using Flux architecture with React on the front end, and JWT authentication and MongoDB on the back end. Deployed on heroku: http://twitook.herokuapp.com
            `,
            },
            {
              title: "JASTdance",
